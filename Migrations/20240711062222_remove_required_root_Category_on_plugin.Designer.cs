...
namespace CarEdit_Server.Data.Migrations
{
    ...
    [Migration("20240711062222_remove_required_root_Category_on_plugin")]
    partial class remove_required_root_Category_on_plugin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shared.Models.Sales.Plugin", b =>
                {
                    ...
                    b.HasOne("Shared.Models.Sales.Plugin", "Parent")
                        .WithMany("Children")
